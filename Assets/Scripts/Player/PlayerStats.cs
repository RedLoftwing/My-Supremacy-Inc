...
public class PlayerStats : MonoBehaviour
{
    ...
    //Called when the player's health needs to be decreased. Uses the value of recievedDamage. Also calls the function to play the anger animation for the Super Villain.
